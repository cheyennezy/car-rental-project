...
<div class="container" style="margin-top: 65px;" >
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        if(mysqli_num_rows($result1)){
            while($row1 = mysqli_fetch_assoc($result1)){
                ...
                $NEW_CARS = $row1["NEW_CARS"];
                $OLD_CARS = $row1["OLD_CARS"];
            }
        }
        ...
        <!-- </div>      -->
         ...
         <h5> Type of Cars:  &nbsp;
            <input onclick="reveal()" type="radio" name="radio1" value="new"><b> NEW Car</b> &nbsp;
            <input onclick="reveal()" type="radio" name="radio1" value="old"><b> USED Car</b>
      ...
      <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6><strong>Note:</strong> You will get <span class="text-danger">$500 OFF</span> for used car.</h6>
        </div>
    </div>
