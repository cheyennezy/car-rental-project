...
$NEW_CARS = $conn->real_escape_string($_POST['NEW_CARS']);
$OLD_CARS = $conn->real_escape_string($_POST['OLD_CARS']);
...
if (!empty($_FILES["uploadedimage"]["name"])) {
    ...
    if(move_uploaded_file($temp_name, $target_path)) {
      ...
      //  $query0 = "UPDATE cars SET car_img = '$target_path' WHERE ";
        ...
        $query = "INSERT into cars(car_name,car_nameplate,car_img,NEW_cars,OLD_cars,car_availability) VALUES('" . $car_name . "','" . $car_nameplate . "','".$target_path."','" . $NEW_CARS . "','" . $OLD_CARS . "','" . $car_availability ."')";
        $success = $conn->query($query);
