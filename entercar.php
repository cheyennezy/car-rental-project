    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="NEW_cars" name="NEW_cars" placeholder="Cost of NEW Car" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="OLD_cars" name="OLD_cars" placeholder="Cost of OLD Car" required>
          </div>
...
<div style="overflow-x:auto;">
  <table class="table table-striped">
    <thead class="thead-dark">
      <tr>
        ...
        <th width="13%"> NEW Car</th>
        <th width="17%"> OLD Car</th>
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo $row["NEW_cars"]; ?></td>
      <td><?php echo $row["OLD_cars"]; ?></td>
